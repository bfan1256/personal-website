...
function Photos() {
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex px-24 justify-start gap-5 overflow-x-scroll scrollbar-hide py-4 sm:gap-8">
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Brandon, a builder at heart who loves to talk about cool sh*t and discover new markets. I'm currently building on a startup and have raised money from top tier VCs."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-7xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 mt-2 dark:text-zinc-100 sm:text-5xl">
            I build and talk about cool sh*t.
          </h1>
          ...
          <p className="mt-2 text-base text-zinc-600 text-lg dark:text-zinc-300">
            brandonfan1256 [at] gmail.com.
          </p>
          <p></p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/bfan1256"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://instagram.com/bfan1256"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/bfan1256"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://linkedin.com/in/brandonfan1256"
