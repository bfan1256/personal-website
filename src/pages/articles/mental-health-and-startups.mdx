...
I've had the "pleasure" to experience this myself. From starting from one direction in finance, to pivoting to developer tooling, to robotics, and to God knows where. 
...
For every startup that gets sent to me that raises a round, I have to remind myself that it's okay to be where I am. And I encourage all founders to do so as well. As a founder, the worst thing that you can do is compare yourself to another company. It's demoralizing and discouraging. 
